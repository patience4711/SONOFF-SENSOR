...
if( sensor[0] == '5' ) { // this works together with timers dus timer[0] can be 1
  if (digitalRead(3) == 1) {
...
void thermostaat() {
  ...
  char b = switchHL[0]; 
      if (temp_c > switch_temp) { // if the polled temperature is heigher
...
bool donker() {
// als sensor[0] == '5' then it is always dark because it has to work day and night
