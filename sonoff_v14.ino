...
void consoleOut(const char* label, int value = 0, const char* someChar = "");
...
if( senSor == 5 ) { // this works together with timers dus timer[0] can be 1
  if (digitalRead(3) == 1) {
      consoleOut("button detected, value = " ,value );
